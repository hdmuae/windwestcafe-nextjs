    ...
    <div>
      ...
      <div className="m-auto flex">
        ...
        <div className="mx-8 mb-20 w-full font-minion text-xl lg:mx-20 lg:w-1/2">
          <h1 className="mt-12 mb-8 font-minion text-4xl font-bold">
          ...
          <h1 className="h1">Interpretation and Definitions </h1>
          ...
          <p>
            ...
            <ol className="list-disc pl-12">
              ...
              <li>
                {" "}
                <span className="font-bold">Country </span>refers to: United
                Arab Emirates
              </li>
              <li>
                <span className="font-bold">Company </span>(referred to as
                either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Wind West Cafe,
                Tecom, Dubai.
              </li>
              <li>
              ...
              <li>
                <span className="font-bold">Website </span>refers to Wind West
                Cafe, accessible from https://windwestcafe.com/
              </li>
              <li>
          ...
          <h1 className="h1">Acknowledgment</h1>
          <p>
          ...
          <h1 className="h1"> Links to Other Websites </h1>
          <p>
          ...
          <h1 className="h1">Termination</h1>
          <p>
          ...
          <h1 className="h1">Governing Law </h1>
          <p>
          ...
          <h1 className="h1">Disputes Resolution</h1>
          <p>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h1 className="h1">For European Union (EU) Users</h1>
          <p>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <h1 className="h1">United States Legal Compliance</h1>
          <p>
          ...
          <h1 className="h1">Severability and Waiver</h1>
          ...
          <h1 className="h1">Translation Interpretation</h1>
          <p>
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <h1 className="h1">Changes to These Terms and Conditions</h1> We
          ...
          <h1 className="h1">Contact Us</h1> If you have any questions about
          these Terms and Conditions, You can contact us:
          <ol className="list-disc pl-12">
            <li>By email: maria@windwestcafe.com</li>
            <li>By phone number: +971501565633</li>
          </ol>
        </div>
      </div>
      <Footer />
